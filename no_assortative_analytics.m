...
for fc = 0:0.005:1
    ...
    for c = 0:0.01:0.50
        ...
        for ii = 1:(n-1)
            ...
            sum_i = sum_i + nchoosek(n-1,ii)*fc^ii*(1-fc)^(n-1-ii)*(ii*(1/n)*((n-1)/n)^(ii-1)*(ii*b/n)+sum_j);
        end
        ...
        for ii = 0:(n-1)
            ...
            sum_ii = sum_ii + nchoosek(n-1,ii)*fc^ii*(1-fc)^(n-1-ii)*(nchoosek((ii+1),1)*(1/n)*((n-1)/n)^(ii)*((ii+1)*b/n)+sum_j);
